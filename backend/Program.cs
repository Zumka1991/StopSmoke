...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5173", "https://stopsmoke.info", "http://stopsmoke.info", "https://www.stopsmoke.info", "http://www.stopsmoke.info")
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
    });
...
provider.Mappings[".fb2"] = "application/x-fictionbook+xml";
